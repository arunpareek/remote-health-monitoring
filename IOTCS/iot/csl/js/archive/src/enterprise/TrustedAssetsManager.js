 ...
 *
 */
lib.enterprise.TrustedAssetsManager = function (taStoreFileExt, taStorePasswordExt) {
    ...
    if (!taStoreFile.endsWith('.json')) {
        ...
        this.load = function () {
            ...
            this.sharedSecret = (entries.sharedSecret ? _decryptSharedSecret(entries.sharedSecret, taStorePassword) : null);
